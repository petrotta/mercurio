...
pub use crate::authoring::authoring::WriteBackMode;
...
use crate::semantic_services::identity::{SemanticAnchor, stable_digest};
...
use crate::semantic_services::variant::{
...
pub fn semantic_reasoning_context_from_authoring_project(
    ...
    semantic_reasoning_context_from_authoring_project_with_oracle(
        ...
        focus,
        max_elements,
        &crate::semantic_services::semantic_profile::ConservativeSemanticCapabilityOracle,
    )
}
