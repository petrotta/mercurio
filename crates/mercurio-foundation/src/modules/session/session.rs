...
use crate::authoring::authoring::AuthoringProject;
...
use crate::workspace::model_state::{
...
impl ForkElement {
    pub fn as_element_ref(&self) -> crate::semantic_services::mutation::ElementRef {
        crate::semantic_services::mutation::ElementRef::new(self.qualified_name.clone())
    }
}

impl From<ForkElement> for crate::semantic_services::mutation::ElementRef {
...
pub enum SessionError {
    ...
    Unsupported(String),
    Kir(KirError),
    Authoring(crate::authoring::authoring::AuthoringError),
...
impl From<crate::authoring::authoring::AuthoringError> for SessionError {
    fn from(value: crate::authoring::authoring::AuthoringError) -> Self {
